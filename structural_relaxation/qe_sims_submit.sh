...
mpiexec -mca btl tcp,self -mca orte_base_help_aggregate 0 -np 16 ~/qe-6.5/bin/pw.x -procs 1 -npool 2 -in ../structural_relaxation/QE_input_scripts/pw.NiPyC2_sc211.relax.in
