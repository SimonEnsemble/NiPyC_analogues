...
# ╔═╡ 86805bb3-9a08-4f28-bf01-15c114cbe2bf
q_axis = connections[1].direction # direct adsorbate travels

# ╔═╡ efbf9d1d-047b-407c-822e-48a817902760
...
function free_energy_on_plane(q::Float64, _xtal::Crystal, _adsorbate::Molecule, 
                              ...
                              nb_total_insertions::Int64=Int(1e6))
...
begin
	qs = range(0.0, 1.0, length=10)
	Fs = [free_energy_on_plane(q, xtal, adsorbate, ljff, id_q_axis, segmented_grid, rep_factors, nb_total_insertions=100) for q in qs]
end
...
begin
	...
	legend(title=@sprintf("D, %s = %.3e cm²/s", String(adsorbate.species), diff_coeff))
	tight_layout()
...
manifest_format = "2.0"
project_hash = "40abccd613e9a7372d822d308d7c65ccda6820d7"
...
[[deps.Xtals]]
deps = ["Aqua", "Bio3DView", "CSV", "DataFrames", "FIGlet", "Graphs", "JLD2", "LinearAlgebra", "Logging", "MetaGraphs", "Printf", "UUIDs"]
